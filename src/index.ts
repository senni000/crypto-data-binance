...
async function bootstrap(): Promise<void> {
  ...
  const cvdReportScheduler = new CVDReportScheduler(databaseManager, alertManager, {
  ...
  setupShutdownHooks(dataCollector, databaseManager, healthMonitor, cvdReportScheduler, backupScheduler);

  await dataCollector.start();
  healthMonitor.start();
  cvdReportScheduler.start();
  if (backupScheduler) {
...
function setupShutdownHooks(
  ...
  cvdReportScheduler: CVDReportScheduler,
